...
FROM
  forms
WHERE
  forms.slug = sqlc.arg ('slug')
  AND forms.creator_id = sqlc.arg ('creator_id');
...
INSERT INTO form_fields (form_version_id, idx, ftype, prompt, required)
  VALUES (sqlc.arg ('form_version_id'), sqlc.arg ('idx'), sqlc.arg
    ('ftype'), sqlc.arg ('prompt'), sqlc.arg ('required'))
RETURNING
